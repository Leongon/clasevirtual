...
INSERT INTO `archivoscurso` VALUES (1,'Este es un pdf para el modulo mariposa',1),(2,'Este es un pdf para el modulo mariposa',1),(3,'Este es un pdf para el modulo mariposa',1),(4,'Este es un pdf para el modulo camisa',2),(5,'Este es un pdf para el modulo camisa',2),(6,'Este es un pdf para el modulo camisa',2);
