...
CREATE TABLE `modulocurso` (
  ...
  `fkgenerocurso` int(11) NOT NULL,
  PRIMARY KEY (`idmodulocurso`),
  KEY `fk_modulo curso_cursos1_idx` (`fkcursomodulo`),
  KEY `fk_modulocurso_genero1_idx` (`fkgenerocurso`),
  ...
  CONSTRAINT `fk_modulocurso_genero1` FOREIGN KEY (`fkgenerocurso`) REFERENCES `genero` (`idgenero`) ON DELETE NO ACTION ON UPDATE NO ACTION
